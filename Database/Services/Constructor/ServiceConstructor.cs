...
namespace CallCentersRD_API.Database.Services.Constructor;
...
public interface IServiceConstructor : IDisposable, IAsyncDisposable
{
    ...
    TService GetService<TService, TEntity, TKey>() where TService : IBaseService<TEntity, TKey> where TEntity : class, IBaseEntity<TKey> where TKey : IEquatable<TKey>;
}
public class ServiceConstructor : IServiceConstructor
{
    ...
    public TService GetService<TService, TEntity, TKey>() where TService : IBaseService<TEntity, TKey> where TEntity : class, IBaseEntity<TKey> where TKey : IEquatable<TKey>
    {
