...
namespace CallCentersRD_API.Database.Services.Base;

public interface IBaseService<TEntity, TKey> where TEntity : class, IBaseEntity<TKey> where TKey : IEquatable<TKey>
{
...
public abstract class BaseService<TEntity, TKey> : IBaseService<TEntity, TKey> where TEntity : class, IBaseEntity<TKey> where TKey : IEquatable<TKey>
{
...
public abstract class BaseCustonService<TRepository, TEntity, TKey> : IBaseService<TEntity, TKey> where TRepository : IBaseRepository<TEntity, TKey> where TEntity : class, IBaseEntity<TKey> where TKey : IEquatable<TKey>
{
    protected readonly IRepositoryConstructor Constructor;
